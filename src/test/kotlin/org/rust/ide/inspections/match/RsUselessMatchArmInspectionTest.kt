...
import org.rust.ide.inspections.checkMatch.RsUselessMatchArmInspection

class RsUselessMatchArmInspectionTest : RsInspectionsTestBase(RsUselessMatchArmInspection::class) {
    ...
    fun `test binding useless`() = checkFixByText("Remove useless match arm", """
        fn main() {
            let x = 42;
            match x {
                y => {}
